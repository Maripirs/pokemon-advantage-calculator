  ...
  return (
    <div className="card-score">
      <div
        ...
        style={{
          background: `linear-gradient(#fff 0 0) padding-box, linear-gradient(to right, ${colors[0]} 50%, ${colors[1]} 50%) border-box`,
          color: `#313149`,
          padding: `1vh`,
        ...
        <div
          ...
          style={
            pokemon
              ? {
                  backgroundImage: `url(${
                    TypeImg[pokemon.types[0].type.name]
                  })`,
                }
              : { backgroundImage: `url(${TypeImg.normal})` }
          }
        >
          {pokemon ? (
      ...
      <div className="pokemon-score">
        <h3 className="score-text">
          Score : {pokemonState.pokemonInBattle[index].pokemonScore}
        </h3>
      </div>
    </div>
  );
